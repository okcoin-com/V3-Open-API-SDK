package com.okcoin.commons.okcoin.open.api.enums;

/**
 * Http Headers Enum . <br/>
 * All REST requests must contain the following headers. <br/>
 * The api key and secret key will be randomly generated and provided by okcoin. <br/>
 * The Passphrase will be provided by you to further secure your API access. <br/>
 * okcoin stores the salted hash of your passphrase for verification, but cannot recover the passphrase if you forget it.<br/>
 * okcoin cursor pagination response headers.<br/>
