...
import com.okcoin.commons.okcoin.open.api.service.spot.SpotProductAPIService;
import com.okcoin.commons.okcoin.open.api.bean.spot.result.*;
import com.okcoin.commons.okcoin.open.api.service.spot.impl.SpotProductAPIServiceImpl;
...
public class SpotProductAPITest extends SpotAPIBaseTests {
    ...
    public void getTickerByProductId() {
        ...
        toResultString(SpotProductAPITest.LOG, "ticker", ticker);
    }
    ...
    public void getMarkPrice(){
        final String markPrice = this.spotProductAPIService.getMarkPrice("BTC-USD");
